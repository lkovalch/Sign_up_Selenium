...
public class Sign_up_Selenium {
	public static void main(String[] args) {
		...
		String title_sign_up_expected = "Welcome to Sign Up/Welcome to Sign Up v1/Welcome to Sign Up v1";
		String title_facebook_expected = "Welcome to Facebook - Log In, Sign Up or Learn More/Facebook - Log In or Sign Up";
		String error_fname_empty_expected = "Please enter First Name";
		String fname = "Lilya";
		String lname = "Kovalchuk";
		String email = "lkovalch@yahoo.com";
		String phone = "703-568-1954";
